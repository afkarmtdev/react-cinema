...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    photoPermission: 'Allow photo access in Settings to pick a picture.',
    errProfileSave: 'Could not save your profile. Try again.',
    favourites: 'Top four',
    favouritesHint:
      'Long press an entry in the library, or tap the heart on its page, to put it here.',
    addFavourite: 'Add to top four',
    removeFavourite: 'Remove from top four',
    favouritesFullTitle: 'Top four is full',
    favouritesFull: 'Take one off the shelf first.',
    language: 'Language',
    settings: 'Settings',
  ...
  ms: {
    ...
    photoPermission:
      'Benarkan akses gambar dalam Tetapan untuk memilih gambar.',
    errProfileSave: 'Tidak dapat menyimpan profil anda. Cuba lagi.',
    favourites: 'Empat teratas',
    favouritesHint:
      'Tekan lama entri dalam koleksi, atau ketik hati di halamannya, untuk meletakkannya di sini.',
    addFavourite: 'Tambah ke empat teratas',
    removeFavourite: 'Buang dari empat teratas',
    favouritesFullTitle: 'Empat teratas sudah penuh',
    favouritesFull: 'Buang satu dari rak dahulu.',
    language: 'Bahasa',
    settings: 'Tetapan',
    appearance: 'Rupa',
    themeCinema: 'Cinema',
